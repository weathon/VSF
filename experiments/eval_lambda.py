...
def vqa(image1: Image.Image, question1: str, question2: str) -> np.ndarray:
    ...
    completion = client.beta.chat.completions.parse(
        ...
        messages=[ 
            ...
            {"role": "user", "content": [
                {"type": "text", "text": "Question 1 is: {question1}, Question 2 is: {question2}."},
    ...
    return [answer.answer_1, answer.answer_2, answer.quality]
...
def process_image(args):
    ...
    answer = vqa(image1, question1, question2)
    return int(image.replace(".png","")), answer
import tqdm
