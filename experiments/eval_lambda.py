...
def process_image(args):
    ...
    image_path = f"results_nag/{run}/{image}"
...
import tqdm
for run in tqdm.tqdm(os.listdir("results_nag")):
    images = os.listdir(f"results_nag/{run}")
    ...
    with open("results_nag/" + run + "/vqa.json", "w") as f:
        json.dump(data, f)
