...
# neg_prompt = "chef hat"
prompt = "A timelapse video that shows the slow and natural change of a single leaf over the course of the autumn season. At the beginning, the leaf is a healthy green color, full of life. As time passes, the leaf slowly begins to change, with hints of yellow and orange appearing. Eventually, the green fades away completely, and the leaf becomes a bright red color, showing the full effect of the fall season. The video captures this gradual transformation clearly, showing the beauty of nature’s cycle during autumn."
